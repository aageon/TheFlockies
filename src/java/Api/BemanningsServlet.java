 ...
 */
@WebServlet(name = "BemanningsServlet", urlPatterns = {"/api/bemanningsservlet"}, initParams = {
    @WebInitParam(name = "url", value = "jdbc:oracle:thin:@ti-oracledb06.thomasmore.be:1521:XE")
    , @WebInitParam(name = "login", value = "c1039600")
    , @WebInitParam(name = "password", value = "5818 ")
    , @WebInitParam(name = "driver", value = "oracle.jdbc.driver.OracleDriver")})
public class BemanningsServlet extends HttpServlet {
...
//    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            List<Bemanningslid> bemanningsleden = dabemanningslid.listBemanning();
            
            Gson gson = new Gson();
            
            response.setContentType("application/json");
            
            response.getWriter().write(gson.toJson(bemanningsleden));
        } catch (Exception e) {
