 ...
 */
@WebServlet(name = "VliegtuigServlet", urlPatterns = {"/api/vliegtuigservlet"}, initParams = {
...
//    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            List<Vliegtuig> vliegtuigen = davliegtuig.listVliegtuigen();
            
            Gson gson = new Gson();
            
            response.setContentType("application/json");
            
            response.getWriter().write(gson.toJson(vliegtuigen));
        } catch (Exception e) {
