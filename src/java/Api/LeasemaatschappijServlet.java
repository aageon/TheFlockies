 ...
 */
@WebServlet(name = "LeasemaatschappijServlet", urlPatterns = {"/api/leasemaatschappijservlet"}, initParams = {
    @WebInitParam(name = "url", value = "jdbc:oracle:thin:@ti-oracledb06.thomasmore.be:1521:XE")
    , @WebInitParam(name = "login", value = "c1039600")
    , @WebInitParam(name = "password", value = "5818 ")
    , @WebInitParam(name = "driver", value = "oracle.jdbc.driver.OracleDriver")})
public class LeasemaatschappijServlet extends HttpServlet {


    private DALeasemaatschappij daleasemaatschappij = null;
    ...
    public void init() throws ServletException {
        try {
            ...
            if (daleasemaatschappij == null) {
                daleasemaatschappij = new DALeasemaatschappij(url, login, password, driver);
            }
...
//    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            List<Leasemaatschappij> leasemaatschappijs = daleasemaatschappij.listLeasemaatschappij();
            
            Gson gson = new Gson();
            
            response.setContentType("application/json");
            
            response.getWriter().write(gson.toJson(leasemaatschappijs));
        } catch (Exception e) {
